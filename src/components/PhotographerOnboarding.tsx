        ...
        <AnimatePresence mode="wait">
          ...
          {currentStep === 0 && (
            ...
            >
              ...
              <h1 className="text-white mb-4"><span className="underline">SnapEvent</span> – Photographer Onboarding</h1>
              <p className="text-xl text-gray-300 mb-8">
                SnapEvent is a new platform to help photographers get more visibility, clients, and bookings.
              </p>
              <Button
                onClick={nextStep}
                className="bg-gradient-to-r from-gray-600 to-gray-800 text-white hover:opacity-90 px-8 py-6 rounded-2xl font-semibold border-2 border-white/20 hover:border-white/40 transition-all duration-300"
              >
                Get Started
          ...
          {currentStep === 5 && (
            ...
            >
              ...
              <p className="text-gray-300 mb-4">
                Our team will review your details and create your <span className="text-white underline">SnapEvent</span> profile soon.
              </p>
